...
const CLASSIC_TRANSPORT = "h-10 w-auto brightness-0 opacity-30";
const CLASSIC_TRANSPORT_PLAY = "h-12 w-auto brightness-0 opacity-30";
  ...
  return (
    <div className="relative z-[2] mt-[-18px] rounded-[26px] bg-white/85 px-8 py-8 backdrop-blur">
      ...
      <button
        ...
        className="absolute bottom-2 right-4 rounded-md px-0 py-1 text-lg font-medium text-black/40 hover:bg-black/5"
